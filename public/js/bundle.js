...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2VyZ2l1dCIsImEiOiJjazE3Zmo4bGswZDZ0M21sbHFkemUyZXM1In0._TR7Yb93MaPaNpxwSfzGmw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/sergiut/ck17flw3m0dyt1cpamqzvy9vl',
...
var stripe = Stripe('pk_test_swa8KgRrQ0rFbYIDCBuDH5XA00rngywvha');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Sign up successfully! Welcome ".concat(name));
              window.setTimeout(function () {
                location.assign('/overview');
              }, 500);
            }

...
exports.getToursWithin = catchAsync(async (req, res, next) => {
    ...
    const radius = unit === 'mi' ? distance / 3963.2 : distance / 6378.1; //first number is the radius of the Earth in miles, the second in km
...
exports.getDistances = catchAsync(async (req, res, next) => {
    ...
    const multiplier = unit === 'mi' ? 0.000621371 : 0.001; //miles to meters
